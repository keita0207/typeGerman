...
const words = ['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s',
               't','u','v','w','x','y','z','ß','ü','ö','ä',
               'auf','teur','immer','gleich','best','circa','doktor','dame','eltern','lachen','kino','wollen','teil','preis','prospekt','möbel',
               'gut','über','klasse','gruß','also','haus','lange','hilfe','hoch','schön','dein','küche','sehen','wein',
               'reiseführer','schwimmbad','straßenbahn','telefonieren','unterschreiben','ausgegehen','ausgesprachen',
