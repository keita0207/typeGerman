...
let errorScore = 0;
let answer = [];
const words = ['auf','teur','immer','gleich','best','circa','doktor','dame','eltern','lachen','kino','wollen','teil','preis','prospekt','möbel',
               'gut','über','klasse','gruß','also','haus','lange','hilfe','hoch','schön','dein','küche','sehen','wein']
...
function nextWords(){
    ...
    inputValue.value = ''
    correct++
    const words = ['auf','teur','immer','gleich','best','circa','doktor','dame','eltern','lachen','kino',
                    'wollen','teil','preis','prospekt','möbel','gut','über','klasse','gruß','also','haus',
                    'lange','hilfe','hoch','schön','dein','küche','sehen','wein'];
    const randomWords = Math.floor(Math.random() * words.length);
    console.log(correct)
